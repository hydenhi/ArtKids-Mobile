...
export default function LoginScreen({ navigation }: any) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const errorMsg = error.response?.data?.message || error.response?.data?.error || 'Sai email hoặc mật khẩu. Vui lòng kiểm tra lại!';
...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 40, fontWeight: '900', color: '#D63031', textAlign: 'center', marginBottom: 5 },
  ...
  loginButton: { backgroundColor: '#00B894', borderRadius: 15, paddingVertical: 15, alignItems: 'center', marginTop: 10, shadowColor: '#00B894', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 5, elevation: 5 },
