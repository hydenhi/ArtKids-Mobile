...
export default function CourseDetailScreen({ route, navigation }: any) {
  ...
  // ✅ Hàm xử lý nút "Vào học ngay" (placeholder)
  const handleGoToLearning = () => {
    Alert.alert(
      "Tính năng đang phát triển",
      "Màn hình học tập sẽ sớm có. Hiện tại bạn đã sở hữu khóa học này!",
      [{ text: "OK" }],
    );
    // TODO: Navigate to Learning screen when ready
    // navigation.navigate("Learning", { courseId: course._id });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {/* ✅ Bottom bar với logic hiển thị thông minh */}
          ...
          <View style={styles.buttonRow}>
            ...
            >
              ...
              <Text style={styles.secondaryButtonText}>
                {alreadyInCart ? "Đã có trong giỏ" : "Giỏ hàng"}
              </Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  secondaryButtonText: { color: "#FF8A80", fontSize: 15, fontWeight: "700" },
  primaryButton: {
    flex: 2,
    backgroundColor: "#FF8A80",
    padding: 16,
  ...
  enrolledButtonText: { color: "#FFF", fontSize: 18, fontWeight: "900" },
});
