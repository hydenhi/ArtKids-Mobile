...
import WishlistScreen from '../screens/Kids/WishlistScreen'; // <-- IMPORT MỚI
...
export default function MainTabNavigator() {
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ focused, color, size }) => {
          ...
          } else if (route.name === 'WishlistTab') { // <-- ICON CHO TAB YÊU THÍCH
    ...
    >
      ...
      <Tab.Screen name="MyCoursesTab" component={MyCoursesScreen} options={{ title: 'Bàn học' }} />
      
      {/* THÊM TAB YÊU THÍCH VÀO ĐÂY */}
      <Tab.Screen name="WishlistTab" component={WishlistScreen} options={{ title: 'Yêu thích' }} />
